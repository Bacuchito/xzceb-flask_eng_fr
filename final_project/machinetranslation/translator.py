"""Creation of a translator english to french"""
import os
import json
...
def english_to_french(english_text):
    """
    Translate the given text from English to French using IBM Watson Language Translator.
    """
...
def french_to_english(french_text):
    """
    Translate the given text from French to English using IBM Watson Language Translator.
    """
    temp = language_translator.translate(
    text=french_text,
